...
Templating.prototype.handleBeforeRender = function (request) {
  ...
  function findTemplate () {
    ...
    return self.reporter.documentStore.collection('templates').find(query, request)
  }
  ...
  return findTemplate().then(function (templates) {
    ...
    request.logger.info('Rendering template {shortid:' + request.template.shortid + ', recipe:' + request.template.recipe +
      ', engine:' + request.template.engine + ', preview:' + (request.options.preview || false) + '}')
  })
}
...
Templating.prototype._configureExpress = function (app) {
  ...
  app.get('/templates/:shortid', function (req, res, next) {
    self.reporter.documentStore.collection('templates').find({
...
Templating.prototype._defineEntities = function () {
  ...
  this.reporter.documentStore.registerEntityType('TemplateType', templateAttributes)
  this.reporter.documentStore.registerEntitySet('templates', {
